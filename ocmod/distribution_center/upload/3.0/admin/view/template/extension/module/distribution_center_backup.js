const{ref:S,computed:we}=Vue,N="extension/module/distribution_center",he='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-8"><path d="M11.47 3.841a.75.75 0 0 1 1.06 0l8.69 8.69a.75.75 0 1 0 1.06-1.061l-8.689-8.69a2.25 2.25 0 0 0-3.182 0l-8.69 8.69a.75.75 0 1 0 1.061 1.06l8.69-8.689Z"></path><path d="m12 5.432 8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75V21a.75.75 0 0 1-.75.75H5.625a1.875 1.875 0 0 1-1.875-1.875v-6.198a2.29 2.29 0 0 0 .091-.086L12 5.432Z"></path></svg>',be='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-8"><path fill-rule="evenodd" d="M9.401 3.003c1.155-2 4.043-2 5.197 0l7.355 12.748c1.154 2-.29 4.5-2.599 4.5H4.645c-2.309 0-3.752-2.5-2.598-4.5L9.4 3.003ZM12 8.25a.75.75 0 0 1 .75.75v3.75a.75.75 0 0 1-1.5 0V9a.75.75 0 0 1 .75-.75Zm0 8.25a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z" clip-rule="evenodd"></path></svg>',ge='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-8"><path d="M5.625 1.5c-1.036 0-1.875.84-1.875 1.875v17.25c0 1.035.84 1.875 1.875 1.875h12.75c1.035 0 1.875-.84 1.875-1.875V12.75A3.75 3.75 0 0 0 16.5 9h-1.875a1.875 1.875 0 0 1-1.875-1.875V5.25A3.75 3.75 0 0 0 9 1.5H5.625Z"></path><path d="M12.971 1.816A5.23 5.23 0 0 1 14.25 5.25v1.875c0 .207.168.375.375.375H16.5a5.23 5.23 0 0 1 3.434 1.279 9.768 9.768 0 0 0-6.963-6.963Z"></path></svg>',ye='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-8"><path fill-rule="evenodd" d="M5.625 1.5H9a3.75 3.75 0 0 1 3.75 3.75v1.875c0 1.036.84 1.875 1.875 1.875H16.5a3.75 3.75 0 0 1 3.75 3.75v7.875c0 1.035-.84 1.875-1.875 1.875H5.625a1.875 1.875 0 0 1-1.875-1.875V3.375c0-1.036.84-1.875 1.875-1.875Zm5.845 17.03a.75.75 0 0 0 1.06 0l3-3a.75.75 0 1 0-1.06-1.06l-1.72 1.72V12a.75.75 0 0 0-1.5 0v4.19l-1.72-1.72a.75.75 0 0 0-1.06 1.06l3 3Z" clip-rule="evenodd"></path><path d="M14.25 5.25a5.23 5.23 0 0 0-1.279-3.434 9.768 9.768 0 0 1 6.963 6.963A5.23 5.23 0 0 0 16.5 7.5h-1.875a.375.375 0 0 1-.375-.375V5.25Z"></path></svg>';function xe(){return new URLSearchParams(window.location.search).get("user_token")||""}function _e(t){const d=new URLSearchParams,a=xe();if(a&&d.set("user_token",a),!t)return d;for(const[c,l]of Object.entries(t))l==null||l===""||d.set(c,String(l));return d}function B(t="",d={},a=!1){const c=a?t:t?`${N}/${t}`:N,o=_e(d).toString();return o?`index.php?route=${c}&${o}`:`index.php?route=${c}`}function ke(){const t=S(0),d=S(0),a=S(0),c=S(0);return{sideMenus:we(()=>[{label:"Home",icon:he,total:c.value,event:()=>{window.location.href=B()}},{label:"Overdue Orders",icon:be,total:t.value,event:()=>{window.location.href=B("overdue")}},{label:"Advance Orders",icon:ge,total:0,event:()=>{window.location.href=B("advance")}},{label:"Revert Orders",icon:ye,total:d.value,event:()=>{window.location.href=B("revertOrders")}}]),totalOverdue:t,totalRevert:d,totalPickup:a,totalNew:c,getRoute:B}}const{defineComponent:Ce}=Vue,K=Ce({components:{},props:[],template:`
  ...
  `,setup(){}}),{defineComponent:$e,onMounted:Me}=Vue,J=$e({props:[],template:`
  ...
  `,setup(){Me(()=>{})}}),{defineComponent:Oe,ref:ze}=Vue,je=Oe({components:{},props:["menus"],template:`
  ...
  `,setup(t){return{showMenu:ze(!1)}}}),{ref:Et,defineComponent:De}=Vue,Be=De({props:["tabs","activeTab"],template:`
  ...
  `,setup(){return{}}}),{base_url:Rt,dir_image:Ht}=window.appConfig,{defineComponent:Ve,defineAsyncComponent:Qt,ref:Wt,computed:Ut,watch:It}=Vue,Pe=Ve({props:["sideMenus","logout","toggleMenu","active"],template:`
  ...
  `,setup(t){return{handleClick:a=>{t.toggleMenu(!1),a()}}}}),{ref:Nt,defineComponent:Te}=Vue,Se=Te({props:["count"],template:`
  ...
  `,setup(){return{}}}),{defineComponent:Ae,computed:Ze}=Vue,A=Ae({components:{},props:["type","disabled","width"],template:`
    <button :disabled="disabled" class="px-10 py-2 rounded-md text-sm font-medium" :class="styles">
      <slot></slot>
    </button>
  `,setup(t){return{styles:Ze(()=>{var a="";switch(t.type){case"primary":a="bg-primary";break;case"secondary":a="bg-primary";break;case"success":a="bg-emerald-500 text-white font-semibold";break;case"outline":a="border-2 border-primary text-primary font-semibold";break;case"outline-warning":a="border-2 border-yellow-700 text-yellow-700 font-semibold";break;default:a="bg-primary";break}return t.width&&(a+=t.width),a})}}}),{defineComponent:qe,ref:Le}=Vue,Fe=qe({components:{Tabs:Be,Loading:K,FilterBtn:J,BulkMenu:je,HamburgerMenu:Pe,Popup:Se,Btn:A},props:["loading","tabs","activeTab","checkedOrders","bulkMenus","toggleFilter","hasFilter","name","logout","back","disableOverflow","bulkLabel","title","hideCheckAll","sideMenus","roCount","roUrl","getRoute","homeUrl","hideClearFilter"],template:`
  ...
  `,setup(t){const d=Le(!1);return{showMenu:d,toggleMenu:c=>{d.value=c}}}}),{ref:Yt,defineComponent:Ee}=Vue,Re=Ee({props:["title","active","total"],template:`
    <div class="px-2">
      <!-- Tab -->
  ...
  `,setup(){return{}}}),{ref:Gt,defineComponent:He}=Vue,Qe=He({props:["showMore","textColor"],template:`
  ...
  `,setup(){return{}}}),{defineComponent:We,ref:Y,computed:q,watch:Ue}=Vue,X=We({components:{ShowMore:Qe,Btn:A},props:["order","products","hideCheckbox","hideShowMore","buttonLabel","hideButton","checkedOrders","status","showWarehouseQty","disableWarehouseQty","showFinalQty","disableFinalQty","menus","hideName","addedBy","updatedBy","hideTotal","disableRo","showOverdue","getRoute","edit"],template:`
  ...
  `,setup(t,{slots:d}){const a=Y(!1),c=Y(!1),l=q(()=>{let r=t.products;return a.value||t.hideShowMore?r:r.slice(0,1)}),o=r=>!!d[r];Ue(()=>t.products.map(r=>({warehouse_qty:r.warehouse_qty,dc_qty:r.dc_qty,partial_weights:r.partial_weights})),(r,v)=>{r.forEach((w,h)=>{const _=t.products[h];_.weight=w.partial_weights.reduce((C,O)=>C+O,0),w.warehouse_qty>0||w.dc_qty>0||_.weight>0?_.out_of_stock=!1:_.out_of_stock=!0})},{deep:!0});const u=(r,v)=>{r[v]>0&&r[v]--,r.out_of_stock=r[v]==0},n=(r,v)=>{r[v]<r.quantity&&r[v]++,r.out_of_stock=r[v]==0},p=async r=>{if(r.partial_weights[r.partial_weights.length-1]!=0){r.partial_weights.push(0),r.out_of_stock=!1,setTimeout(()=>{$(`#pw-${r.order_product_id}-${r.partial_weights.length-1}`).focus()},1);try{const{data:v}=await axios.post(t.getRoute("extension/module/processing_department/updateWeight",{},!0),{order_product_id:r.order_product_id,partial_weights:r.partial_weights.filter(w=>w!=0)})}catch(v){console.error(v)}}},x=async(r,v)=>{v.partial_weights.splice(r,1);try{const{data:w}=await axios.post(t.getRoute("extension/module/processing_department/updateWeight",{},!0),{order_product_id:v.order_product_id,partial_weights:v.partial_weights.filter(h=>h!=0)})}catch(w){console.error(w)}},j=r=>{c.value=!1,r(t.order)},m=q(()=>{const r=t.order.delivery_date,[v,w,h]=r.split("/").map(Number),_=new Date(h,w-1,v),C=new Date;return C.setHours(0,0,0,0),_.getTime()===C.getTime()}),k=q(()=>{const r=t.order.delivery_date,[v,w,h]=r.split("/").map(Number),_=new Date(h,w-1,v),C=new Date;return C.setHours(0,0,0,0),_.getTime()<C.getTime()});return{showMenu:c,showMore:a,computedProducts:l,hasSlot:o,handleDecrease:u,handleIncrease:n,handleMenuClick:j,isPrimary:m,isOverdue:k,addWeight:p,removeWeight:x}}}),{defineComponent:Ie}=Vue,E=Ie({props:["fill"],template:`
  ...
  `}),{defineComponent:Ne}=Vue,Ye=Ne({components:{Order:X,Closebtn:E},props:["order","type","products","toggleConfirm","showUpdate","disableUpdate","hideButton","buttonLabel","showWarehouseQty","disableWarehouseQty","showFinalQty","disableFinalQty"],template:`
  ...
  `,setup(){}}),Ge="modulepreload",Ke=function(t){return"/"+t},G={},D=function(d,a,c){let l=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),n=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));l=Promise.allSettled(a.map(p=>{if(p=Ke(p),p in G)return;G[p]=!0;const x=p.endsWith(".css"),j=x?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${j}`))return;const m=document.createElement("link");if(m.rel=x?"stylesheet":Ge,x||(m.as="script"),m.crossOrigin="",m.href=p,n&&m.setAttribute("nonce",n),document.head.appendChild(m),x)return new Promise((k,r)=>{m.addEventListener("load",k),m.addEventListener("error",()=>r(new Error(`Unable to preload CSS for ${p}`)))})}))}function o(u){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=u,window.dispatchEvent(n),!n.defaultPrevented)throw u}return l.then(u=>{for(const n of u||[])n.status==="rejected"&&o(n.reason);return d().catch(o)})},{base_url:ee}=window.appConfig,{ref:Kt,defineComponent:Je,defineAsyncComponent:te}=Vue,Xe=te(()=>D(()=>import(`${ee}/extension/module/components/order.js`),[])),et=te(()=>D(()=>import(`${ee}/extension/module/components/close_btn.js`),[])),tt=Je({components:{Order:Xe,Closebtn:et},props:["order","type","toggleConfirm","getRoute"],template:`
  ...
  `,setup(){}}),{base_url:rt}=window.appConfig,{defineComponent:ot,defineAsyncComponent:st}=Vue,it=st(()=>D(()=>import(`${rt}/extension/module/components/close_btn.js`),[])),lt=ot({components:{Closebtn:it},props:["order"],template:`
    <div class="z-40 fixed top-0 left-0 w-screen h-screen bg-black/70 flex justify-center items-center">
  ...
  `,setup(t){}}),{base_url:nt}=window.appConfig,{defineComponent:at,defineAsyncComponent:dt,ref:ct}=Vue,ut=dt(()=>D(()=>import(`${nt}/extension/module/components/close_btn.js`),[])),pt=at({components:{Closebtn:ut},props:["order","deliveryZones"],template:`
  ...
  `,setup(t){return{deliveryZoneId:ct("")}}}),{base_url:vt}=window.appConfig,{defineComponent:mt,defineAsyncComponent:ft}=Vue,wt=ft(()=>D(()=>import(`${vt}/extension/module/components/close_btn.js`),[])),ht=mt({components:{Closebtn:wt},props:["order"],template:`
    <div class="z-40 fixed top-0 left-0 w-screen h-screen bg-black/70 flex justify-center items-center">
      <div class="w-11/12 mx-auto bg-white rounded-2xl p-4">
        <!-- Close Btn -->
        <Closebtn @click="$emit('close')"></Closebtn>
  ...
  `,setup(t){}}),{defineComponent:bt}=Vue,gt=bt({components:{},props:[],template:`
    <p class="text-gray-600 text-xl font-medium text-center">No Data</p>
  `,setup(){}}),{base_url:yt}=window.appConfig,{defineComponent:xt,defineAsyncComponent:_t}=Vue,kt=_t(()=>D(()=>import(`${yt}/extension/module/components/close_btn.js`),[])),Ct=xt({components:{Closebtn:kt},props:["checkedOrders"],template:`
    <div class="z-40 absolute top-0 left-0 w-screen h-screen bg-black/70 flex justify-center items-center">
      <div class="w-11/12 mx-auto bg-white rounded-2xl p-4">
        <!-- Close Btn -->
        <Closebtn @click="$emit('close')"></Closebtn>
  ...
  `,setup(t){}}),{defineComponent:$t,onMounted:Mt}=Vue,Ot=$t({components:{Closebtn:E},props:["filterData","deliveryZones"],template:`
  ...
  `,setup(t){const d={startDate:moment().add(5,"days"),autoUpdateInput:!1,autoApply:!0,singleDatePicker:!0},a=()=>{for(const c in t.filterData)t.filterData.hasOwnProperty(c)&&(t.filterData[c]="")};return Mt(()=>{const c=t.filterData.delivery_date;c!=""&&$('input[name="delivery_date"]').val(c),$('input[name="delivery_date"]').daterangepicker(d,l=>{const o=l.format("MM/DD/YYYY");t.filterData.delivery_date=o})}),{clear:a}}}),{defineComponent:zt,ref:jt}=Vue,Dt=zt({props:["deliveryZone","driver","phone"],template:`
  ...
  `,setup(t){return{collapsed:jt(!1)}}}),{ref:Jt,defineComponent:Bt}=Vue,Vt=Bt({props:[],template:`
  ...
  `,setup(){return{}}}),{defineComponent:Pt,onMounted:Tt,watch:St}=Vue,At=Pt({components:{Btn:A},props:["customer","index","productUrl","orderUrl","submitUrl"],template:`
  ...
  `,setup(t){St(()=>t.customer.orders.flatMap(l=>l.products.map(o=>o.partial_weights)),(l,o)=>{l.forEach((u,n)=>{const p=t.customer.orders.flatMap(x=>x.products)[n];p.weight=u.reduce((x,j)=>x+parseFloat(j||0),0)})},{deep:!0});const d=async(l,o)=>{const u=o.products.map(n=>({order_product_id:n.order_product_id,partial_weights:n.partial_weights,dc_qty:l?n.dc_qty:0,weight:l?n.weight:0,checked:l?1:0}));o.products.forEach(n=>{n.dc_qty=l?n.dc_qty:n.warehouse_qty,n.checked=l});try{const n=await axios.post(t.orderUrl,{order_id:o.order_id,products:u});if(n.data.error)throw new Error(n.data.error)}catch(n){console.error(n)}finally{l||o.products.forEach(n=>{n.dc_qty=n.warehouse_qty})}},a=async(l,o)=>{const u={order_product_id:o.order_product_id,partial_weights:o.partial_weights,dc_qty:l?o.dc_qty:0,checked:l?1:0};l?o.dc_qty=o.dc_qty:(o.out_of_stock=0,o.dc_qty=o.warehouse_qty),o.checked=l;try{const n=await axios.post(t.productUrl,u)}catch(n){console.error("Error update product : ",n)}},c=l=>l.products.every(o=>o.checked);return Tt(()=>{t.customer.orders.forEach(l=>{l.products.forEach(o=>{o.checked||(o.dc_qty=o.warehouse_qty)})})}),{onOrderCheck:d,onProductCheck:a,orderIsChecked:c}}}),{defineComponent:Zt,ref:L}=Vue,qt=Zt({components:{Closebtn:E},props:["action"],template:`
    <Transition>
  ...
  `,setup(t){const d=L(""),a=L(""),c=L(!1);return{title:d,description:a,show:c,close:()=>{c.value=!1},confirm:()=>{c.value=!1,t.action()},open:(n,p)=>{d.value=n,a.value=p,c.value=!0}}}}),{createApp:Lt,ref:f,onMounted:Ft,computed:F}=Vue;Lt({components:{Layout:Fe,Secondtab:Re,Order:X,Loading:K,Ordermodal:Ye,Updatemodal:tt,Confirmactionmodal:lt,Changedriver:pt,Confirmrevert:ht,Nodata:gt,Confirmgeneratedo:Ct,Filtermodal:Ot,Filterbtn:J,Driverinfo:Dt,Revertbtn:Vt,Btn:A,Dcorder:At,Confirmmodal:qt},setup(){const{sideMenus:t,totalOverdue:d,totalRevert:a,totalPickup:c,totalNew:l,getRoute:o}=ke(),u=f(1),n=f(10),p=f(!1),x=f("New"),j=f("MO Area"),m=f({}),k=f("processed"),r=f(!1),v=f([]),w=f([]),h=f([]),_=f(null),C=f(!1),O=f(null),re=f(!1),V=f(()=>{}),P=f([]),oe=F(()=>[{label:"New",event:()=>T("New"),total:l.value},{label:"Pickup",event:()=>T("Pickup")}]),R=(e={})=>{const s=new URL(window.location.href);for(const[i,g]of Object.entries(e))s.searchParams.set(i,g);window.history.pushState({},"",s)},H=()=>{const e=new URLSearchParams(window.location.search).get("delivery_zone_id");if(e){const s=P.value.find(i=>i.delivery_zone_id==e);s&&Q(s)}},T=async e=>{if(x.value=e,h.value=[],e=="New"){Object.keys(b.value).forEach(i=>{i!=="delivery_zone_id"&&(b.value[i]="")});const s=new URLSearchParams(window.location.search);s.has("delivery_zone_id")&&(b.value.delivery_zone_id=s.get("delivery_zone_id")),m.value={},await M("processed"),H()}else e=="Ready To Ship"?(b.value.delivery_zone_id="",M("ready_to_ship")):e=="Pickup"&&(b.value.delivery_zone_id="",M("pickup"))},Q=(e,s=!1)=>{m.value.delivery_zone_id==e.delivery_zone_id?m.value={}:(m.value=e,b.value.delivery_zone_id=e.delivery_zone_id,s&&R({delivery_zone_id:e.delivery_zone_id}),M("processed",!0))},W=e=>{r.value=e},se=(e,s)=>{if(e){if(h.value.includes(s))return;h.value.push(s)}else h.value=h.value.filter(i=>i.order_id!=s.order_id)},M=async(e,s=!1)=>{p.value=!0;let i=k.value!=e;k.value=e,(i||s)&&(w.value=[],u.value=1);const g=o("orders",{status:e,...b.value,delivery_date:new Date().toISOString().split("T")[0],page:u.value,limit:n.value});try{const{data:y}=await axios.get(g);P.value=y.delivery_zones,k.value=="processed"?v.value=y.orders:w.value=w.value.concat(y.orders),l.value=y.total.processed,c.value=y.total.pickup,a.value=y.total.revert,d.value=y.total.overdue,m.value.delivery_zone_id&&R({delivery_zone_id:m.value.delivery_zone_id})}catch(y){console.log(y)}finally{p.value=!1}},ie=e=>P.value.find(i=>i.delivery_zone_id==e).total,le=(e=null)=>{_.value=e,C.value=e!=null},z=(e,s="success")=>{let i="#16a34a";s=="error"&&(i="#de2837"),Toastify({text:e,duration:3e3,close:!0,gravity:"top",position:"right",stopOnFocus:!0,style:{background:i}}).showToast()},ne=e=>{O.value&&(O.value.open("Revert Order ?",`Order <b>#${e.order_id}</b> will be revert back to original status.`),V.value=()=>U(e))},U=async e=>{p.value=!0;const s=o("revert"),i=await axios.post(s,{order_id:e.order_id});i.data.success?z(i.data.success):z(i.data.error,"error"),await T("New")},ae=async()=>{p.value=!0;const e=h.value.map(g=>g.order_id),s=o("sale/order/delivery_order",{},!0),i=o("markPickup");try{const g=await axios.post(s,{selected:e}),y=await axios.post(i,{selected:e});h.value=[],z("Delivery Order generated !"),T("Pickup")}catch(g){z(g,"error")}finally{p.value=!1}},b=f({customer:"",order_id:"",delivery_date:"",doc_no:""}),de=e=>{W(!1),M(k.value,!0)},Z=(e=[])=>{for(const s in b.value)b.value.hasOwnProperty(s)&&!e.includes(s)&&(b.value[s]="");M(k.value,!0)},ce=F(()=>{var e=!1;for(const s in b.value)s=="delivery_zone_id"&&b.value[s]!=""&&(e=!0),s!="delivery_zone_id"&&b.value[s]!=""&&(e=!1);return e}),ue=F(()=>Object.keys(b.value).some(e=>b.value[e]!="")),pe=()=>{u.value+=1,M(k.value)},ve=e=>{if(O.value){const s=e.shipping_firstname+e.shipping_lastname;O.value.open("Submit Orders",`You're submitting all orders for this <b>${s}</b>. Continue?`),V.value=()=>me(e)}},me=async e=>{const s={orders:e.orders.map(i=>({order_id:i.order_id,products:i.products.map(g=>({order_product_id:g.order_product_id,partial_weights:g.partial_weights,dc_qty:g.dc_qty,weight:g.weight,checked:1}))}))};try{p.value=!0;const i=await axios.post(o("completeOrders"),s);i.data.success?(z(i.data.success),Z(["delivery_zone_id"]),M("processed")):i.data.error&&z(i.data.error,"error")}catch(i){console.error(i)}},fe=()=>{O.value&&(O.value.open(`${m.value.name} Orders`,`You're submitting all orders for this <b>${m.value.name}</b>. Continue?`),V.value=()=>I())},I=async()=>{p.value=!0;const e=o("completeOrders"),s={orders:[]};v.value.forEach(i=>{i.orders.forEach(g=>{g.products.forEach(y=>{s.orders.push({order_id:g.order_id,order_product_id:y.order_product_id,dc_qty:y.dc_qty,weight:y.weight,checked:1})})})});try{const i=await axios.post(e,s);i.data.success?(z(i.data.success),Z(["delivery_zone_id"]),M("processed")):i.data.error&&z(i.data.error,"error")}catch(i){z(i.message,"error")}};return Ft(async()=>{await M("processed"),H()}),{sideMenus:t,loading:p,orders:w,checkedOrders:h,tabs:oe,activeTab:x,secondActiveTab:j,selectedOrder:_,showOrder:C,toggleOrder:le,deliveryZones:P,revert:U,showRevert:ne,toggleDeliveryZone:Q,generateDO:ae,showFilter:r,toggleFilter:W,handleFilter:de,filterData:b,handleOnCheck:se,clearFilter:Z,hasFilter:ue,getRoute:o,loadMore:pe,totalRevert:a,selectedZone:m,hideClearFilter:ce,getZoneTotalOrder:ie,customerOrders:v,showSubmit:ve,showSubmitAll:fe,submitAll:I,showConfirm:re,confirmAction:V,confirmModal:O,totalPickup:c,totalNew:l}}}).mount("#app");
